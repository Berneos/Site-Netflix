        ...
        <div id="content">
            ...
            <div class="container">
                ...
                <div class="row gx-5">
                    ...
                    <div class="col col-lg-3 col-md-6 col-sm-12">
                        <img src="images/catalogo/series/myadventures.jpg" alt="" class="imagens">
                    </div>
                    <div class="col col-lg-3 col-md-6 col-sm-12">
                ...
                <div class="row gx-5">
                    <div class="col col-lg-3 col-md-6 col-sm-12">
                        <img src="images/catalogo/filmes/guardioes3.jpg" alt="" class="imagens">
                    </div>
                    <div class="col col-lg-3 col-md-6 col-sm-12">
                        <img src="images/catalogo/filmes/mariobros.jpg" alt="" class="imagens">
                    </div>
                    <div class="col col-lg-3 col-md-6 col-sm-12">
                        <img src="images/catalogo/filmes/acrossspiderverse.jpg" alt="" class="imagens">
                    </div>
                    <div class="col col-lg-3 col-md-6 col-sm-12" >
                ...
                <div class="row gx-5">
                    <div class="col col-lg-3 col-md-6 col-sm-12">
                        <img src="images/catalogo/series/barry.jpg" alt="" class="imagens">
                    </div>
                    <div class="col col-lg-3 col-md-6 col-sm-12">
                        <img src="images/catalogo/filmes/johnwick4.jpg" alt="" class="imagens">
                    </div>
                    <div class="col col-lg-3 col-md-6 col-sm-12">
                        <img src="images/catalogo/filmes/elementos.jpg" alt="" class="imagens">
                    </div>
                    <div class="col col-lg-3 col-md-6 col-sm-12" >
                        <img src="images/catalogo/filmes/panico6.jpg" alt="" class="imagens">
                    </div>
                </div>
                <div class="row gx-5">
                    <div class="col col-lg-3 col-md-6 col-sm-12">
                        <img src="images/catalogo/filmes/asmarvels.jpg" alt="" class="imagens">
                    </div>
                    <div class="col col-lg-3 col-md-6 col-sm-12">
                        <img src="images/catalogo/filmes/aquaman2.jpg" alt="" class="imagens">
                    </div>
                    <div class="col col-lg-3 col-md-6 col-sm-12">
                        <img src="images/catalogo/filmes/jogosvorazesnovo.jpg" alt="" class="imagens">
                    </div>
                    <div class="col col-lg-3 col-md-6 col-sm-12" >
                        <img src="images/catalogo/filmes/wonka.jpg" alt="" class="imagens">
                    </div>
                </div>
                <div class="row gx-5">
                    <div class="col col-lg-3 col-md-6 col-sm-12">
                        <img src="images/catalogo/filmes/farofeiros2.jpg" alt="" class="imagens">
                    </div>
                    <div class="col col-lg-3 col-md-6 col-sm-12">
                        <img src="images/catalogo/filmes/anewhome.jpg" alt="" class="imagens">
                    </div>
                    <div class="col col-lg-3 col-md-6 col-sm-12">
                        <img src="images/catalogo/filmes/tasm3.jpg" alt="" class="imagens">
                    </div>
                    <div class="col col-lg-3 col-md-6 col-sm-12" >
                        <img src="images/catalogo/filmes/thebatman2.jpg" alt="" class="imagens">
                    </div>
                </div>
